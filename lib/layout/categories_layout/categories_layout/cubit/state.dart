...
class SuccessFirstPayment extends HomeState{}

class ErrorFirstPayment extends HomeState{
  final String error;
  ErrorFirstPayment(this.error);

}class SuccessOrderPayment extends HomeState{}

class ErrorOrderPayment extends HomeState{
  final String error;

  ErrorOrderPayment(this.error);
}
